...
$(function () {
    ...
    $('.delete-service').on('click', function () {
        var id = this.id;
        $('#lbl-service').html('Confirm deletation of service with id: '+id+'?');
        $('input[name=delete-service]').val(id);
    ...
    $('.edit-service').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('input[name=edit-service]').val(id);
                $('input[name=service]').val(response.name);
                $('select[name=category]').val(response.categoryName);
