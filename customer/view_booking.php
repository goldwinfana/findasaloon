        ...
        <section class="" style="padding: 30px">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <?php
                  $bookingID = isset($_GET['booking_id'])? $_GET['booking_id']: 80001;
                  $init = $pdo->open();
                  $sql = $init->prepare("SELECT *,session.id AS bookID,session.status AS st FROM session,staff,saloon,service 
                                                        WHERE session.id=:id AND session.staffID=staff.staffID
                    ...
                    <div class="d-block align-items-center">
                        ...
                        <div class="row margin-bottom-sm margin-top-sm">
                            <div style="margin: auto;display: flex">
                                ...
                                <div id="map" style="height: auto;width: 600px;z-index: 0"></div>
                            ...
                            <div class="margin-top-sm contributions">
                                ...
                                <p>Booking Details</p>
                                    ...
                                    <span class="service">Service Booked: '.$data["serviceName"].'</span>
                                    <span class="duration">Duration: '.$data["duration"].' Hours</span>
                                    <span class="price">Cost: R'.$data["price"].'</span>
                                    <span >Date: '.$data["date"].'</span>
                                    <span >Start Time: '.$data["startTime"].'</span>
                                    <span >Stop Time: '.$data["endTime"].'</span>
                                    <span class="stuff">Stuff Name: '.$data["staffName"].'</span>
                  ...
                  ';}
                      ...
                      echo '<div style="margin: 200px;width: 100%;text-align: center"><h3>No Session Found !!!</h3></div>';
                  }
                  $pdo->close();?>
                </div>
            </div>
