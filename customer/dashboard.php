        ...
        <section class="no-padding-top no-padding-bottom">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <a class=" top-bannner col-md-3 col-sm-6" href="pending.php">
                        <div class="statistic-block block">
                            <div class="progress-details d-flex align-items-end justify-content-between">
                                <div class="title">
                                    ...
                                    <div class="align-items-center">
                                        ...
                                        <div class="d-block align-items-center">
                                            <strong class="d-block">
                                                <a id="'.$data["id"].'" class="post-title" style="color: cadetblue;" href="saloon.php?saloon_id= '.$data["id"].'">'.$data["name"].' <small style="text-decoration: none;color: currentColor;" class="text-white-50 font-weight-lighter">'.$data["address"].'</small></a>
