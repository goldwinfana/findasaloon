            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <table id="example1" class="table table-bordered" style="width: 100%;">
                        ...
                        <?php
                        $init = $pdo->open();
                        $sql = $init->prepare("SELECT *,session.status AS salStat,session.id AS bookID FROM session,saloon,service 
                                                        WHERE customerID=:id AND session.service=service.id 
                                                        AND saloon.id=session.saloonID AND session.status='pending'");
